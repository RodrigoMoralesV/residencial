...
<form class="form-floating pl-5" action="{{ route('residentes.update',$residentes->id) }}" method="post">
  ...
  <div class="mb-3 col-md-3 pt-4">
    ...
    <input type="text" class="form-control" name="nombre" value="{{ old('nombre',$residentes->nombre) }}" placeholder="Nombre" autofocus required>
  </div>
  ...
  <div class="mb-3 col-md-3">
    ...
    <input type="text" class="form-control" name="movil" value="{{ old('movil',$residentes->movil) }}" placeholder="Teléfono" required>
  </div>
